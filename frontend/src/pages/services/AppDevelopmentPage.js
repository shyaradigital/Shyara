        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18, marginBottom: 18 }}>
          ...
          <div style={{ display: 'flex', gap: 16, flexWrap: 'wrap' }}>
            ...
            >
              ...
              {isBasicInCart ? 'Added' : 'Basic App ₹30,000+'}
            </button>
            <button
              style={{ flex: 1, minWidth: 140, background: isEnterpriseInCart ? 'rgba(162,89,247,0.10)' : 'rgba(162,89,247,0.18)', color: '#a259f7', border: '1.5px solid #a259f7', borderRadius: 999, padding: '0.7rem 1.2rem', fontWeight: 700, fontSize: '1.05rem', display: 'flex', alignItems: 'center', gap: 8, boxShadow: '0 2px 12px #0002', cursor: isEnterpriseInCart ? 'not-allowed' : 'pointer', opacity: isEnterpriseInCart ? 0.6 : 1, transition: 'background 0.2s, transform 0.2s', outline: 'none' }}
            ...
            >
              <ShoppingCart style={{ width: 18, height: 18 }} />
              {isEnterpriseInCart ? 'Added' : 'Enterprise (Custom)'}
            </button>
          </div>
        </div>
